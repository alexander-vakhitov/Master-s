...
dataDir = './data';
resultsDir = 'ain_results-20131012';

addpath(genpath('./20131003'));

mkdir(resultsDir);

filename = {'stabilized_4068.avi', 'stabilized_4518.avi', 'stabilized_4519.avi'};

%% vanilla
for i=1:3 
inFile = fullfile(dataDir, filename{i});
