...
%% guitar
%% AIN 2013-09-05 Out of memory inFile = fullfile(dataDir,'guitar.mp4');
%% AIN 2013-09-05 Out of memory fprintf('Processing %s\n', inFile);
% amplify E
%% AIN 2013-09-05 Out of memory amplify_spatial_lpyr_temporal_ideal(inFile, resultsDir, 50, 10, 72, 92, 600, 0);
% amplify A
%% AIN 2013-09-05 Out of memory amplify_spatial_lpyr_temporal_ideal(inFile, resultsDir, 100, 10, 100, 120, 600, 0);
